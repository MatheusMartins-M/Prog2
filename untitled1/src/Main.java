...
public class Main {
    ...
    static void carregarEstoque() throws Exception{
        ...
        while(Texto.hasNextLine()){
            ...
            int codigo = Integer.parseInt(SL[0]);
            String titulo = SL[1];
            int ano = Integer.parseInt(SL[2]);
            String area = SL[3];
            String editora = SL[4];
            double valor = Double.parseDouble(SL[5].replace("R$", "").replace(",", ""));
            int quantidadeEstoque = Integer.parseInt(SL[6]);
